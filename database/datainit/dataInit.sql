...
VALUES
    ('admin', 'test@user.com', 'password', 'admin', 'admin', '+33612345678', 1, NULL),
    ('staff', 'staff@user.com', 'password', 'staff', 'staff', '+33612345678', 2, NULL),
    ('customer', 'customer@user.com', 'password', 'customer', 'customer', '+33612345678', 3, NULL), -- Ensuring customer with id=3 exists
    ('provider', 'provider@user.com', 'password', 'provider', 'provider', '+33612345678', 4, 1),  -- Existing service provider user
    ...
    ('provider', 'secureguard@provider.com', 'password', 'Secure', 'Guard', '+33645678901', 4, 5), -- SecureGuard user
    ('provider', 'transpro@provider.com', 'password', 'Trans', 'Pro', '+33656789012', 5, 6); -- TransPro user
